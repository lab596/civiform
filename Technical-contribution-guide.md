...
To set up your environment and learn how to run a local CiviForm server and tests, see [Getting started.](https://github.com/civiform/civiform/wiki/Getting-started)
...
[getting-started.md](https://github.com/civiform/civiform/wiki/Getting-started)
{% endcontent-ref %}

{% content-ref url="technology-overview.md" %}
[technology-overview.md](https://github.com/civiform/civiform/wiki/Technology-overview)
{% endcontent-ref %}

{% content-ref url="development-standards.md" %}
[development-standards.md](https://github.com/civiform/civiform/wiki/Development-standards)
{% endcontent-ref %}
