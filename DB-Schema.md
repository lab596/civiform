...
Each table is mapped to a [model/ class](https://github.com/seattle-uat/civiform/tree/main/universal-application-tool-0.0.1/app/models), and the classes contain more context.
