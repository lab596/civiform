User created data (Questions, Programs) are all *versioned*. This doc discusses the versioning mechanism and the data life cycle that drives it. Related[ user docs on managing versions](https://docs.civiform.us/user-manual/civiform-admin-guide/manage-versions-for-programs-and-questions) also exist.
