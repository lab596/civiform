...
public final class WellKnownPaths {
  ...
  public static Path APPLICANT_EMAIL = Path.create("applicant.email");
  public static Path APPLICANT_DOB = Path.create("applicant.applicant_date_of_birth");
  public static Path APPLICANT_NOTES = Path.create("applicant.notes");
  public static Path APPLICANT_ARCHIVED = Path.create("applicant.archived");
}
