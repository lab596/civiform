Feature flags are a mechanism to customize or hide behavior until explicitly enabled.
...
5. Enable the flag in AWS staging and ask Seattle engineers to enable the flag in their staging environment.
